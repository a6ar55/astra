#!/usr/bin/env python3
"""
Train a binary threat detection model (Stage 1)
This model classifies if a text is a threat or non-threat.
"""
import os
import argparse
import torch
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train a binary threat detection model (Stage 1)")
    ...
    parser.add_argument("--output_dir", type=str, default="../models/stage1_bin", help="Directory to save model")
    parser.add_argument("--data_path", type=str, default="../data/stage1_binary_dataset.csv", 
                        help="Path to binary dataset CSV")
